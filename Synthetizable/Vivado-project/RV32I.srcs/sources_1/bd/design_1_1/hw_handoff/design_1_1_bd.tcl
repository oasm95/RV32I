...
################################################################
# This is a generated script based on design: design_1_1
#
...
proc create_root_design { parentCell } {
  ...
  # Create instance: tbSynth_0, and set properties
  set block_name tbSynth
  set block_cell_name tbSynth_0
  if { [catch {set tbSynth_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
  ...
  connect_bd_intf_net -intf_net axi_smc_M04_AXI [get_bd_intf_pins axi_smc/M04_AXI] [get_bd_intf_pins processing_system7_0/S_AXI_HP0]
  ...
  connect_bd_net -net tbSynth_0_DONE [get_bd_pins tbSynth_0/DONE] [get_bd_pins xlconcat_3/In1]
  connect_bd_net -net tbSynth_0_Dhigh [get_bd_pins axi_bram_ctrl_0_bram/enb] [get_bd_pins axi_bram_ctrl_1_bram/enb] [get_bd_pins axi_bram_ctrl_2_bram/enb] [get_bd_pins axi_bram_ctrl_3_bram/enb] [get_bd_pins tbSynth_0/Dhigh]
  connect_bd_net -net tbSynth_0_Din1Addr [get_bd_pins axi_bram_ctrl_0_bram/addrb] [get_bd_pins tbSynth_0/Din1Addr]
  connect_bd_net -net tbSynth_0_Din2Addr [get_bd_pins axi_bram_ctrl_1_bram/addrb] [get_bd_pins tbSynth_0/Din2Addr]
  connect_bd_net -net tbSynth_0_Dout1 [get_bd_pins axi_bram_ctrl_2_bram/dinb] [get_bd_pins tbSynth_0/Dout1]
  connect_bd_net -net tbSynth_0_Dout1Addr [get_bd_pins axi_bram_ctrl_2_bram/addrb] [get_bd_pins tbSynth_0/Dout1Addr]
  connect_bd_net -net tbSynth_0_Dout1Wen [get_bd_pins tbSynth_0/Dout1Wen] [get_bd_pins xlconcat_2/In0] [get_bd_pins xlconcat_2/In1] [get_bd_pins xlconcat_2/In2] [get_bd_pins xlconcat_2/In3]
  connect_bd_net -net tbSynth_0_Dout2 [get_bd_pins axi_bram_ctrl_3_bram/dinb] [get_bd_pins tbSynth_0/Dout2]
  connect_bd_net -net tbSynth_0_Dout2Addr [get_bd_pins axi_bram_ctrl_3_bram/addrb] [get_bd_pins tbSynth_0/Dout2Addr]
  connect_bd_net -net tbSynth_0_Dout2Wen [get_bd_pins tbSynth_0/Dout2Wen] [get_bd_pins xlconcat_1/In0] [get_bd_pins xlconcat_1/In1] [get_bd_pins xlconcat_1/In2] [get_bd_pins xlconcat_1/In3]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins processing_system7_0/IRQ_F2P] [get_bd_pins xlconcat_0/dout]
  connect_bd_net -net xlconcat_1_dout [get_bd_pins axi_bram_ctrl_3_bram/web] [get_bd_pins xlconcat_1/dout]
  connect_bd_net -net xlconcat_2_dout [get_bd_pins axi_bram_ctrl_2_bram/web] [get_bd_pins xlconcat_2/dout]
  connect_bd_net -net xlconcat_3_dout [get_bd_pins processing_system7_0/GPIO_I] [get_bd_pins xlconcat_3/dout]
  connect_bd_net -net xlslice_0_Dout [get_bd_pins tbSynth_0/RST] [get_bd_pins xlslice_0/Dout]
