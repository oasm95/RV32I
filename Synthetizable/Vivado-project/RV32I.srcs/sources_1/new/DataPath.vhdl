...
begin
    ...
    rd_Wen <= RegFile_Wen AND NOT STALL;
    ...
    --***********CSR allow writes *******
    csr_wen_traps<= CSRFile_Trap_Wen and not STALL;
    ...
    begin
        ...
        allowcsrwrite<= CSRFile_Wen and (not ((not isnotreg0) and isnotcsrrw)) and NOT STALL;
    end process;    
    -- **********JUMPtarget calc*********
    ...
    Mem_Access<= (load_opcode and not loadmisalig) or (store_opcode and not storemisalig);
