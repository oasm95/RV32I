...
HD_PWD='C:/Users/Yoadmin/Documents/git/RV32I/Synthetizable/Vivado project/RV32I.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log microcontroler_tb_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source microcontroler_tb_wrapper.tcl
