...
HD_PWD='C:/Users/Yoadmin/Documents/git/RV32I/Synthetizable/Vivado project/RV32I.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log microcontroler_tb_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source microcontroler_tb_wrapper.tcl -notrace
