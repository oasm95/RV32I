...
HD_PWD='C:/Users/Yoadmin/Documents/vivado/RV32I/RV32I.runs/microcontroler_tb_axi_bram_ctrl_Instr_bram_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log microcontroler_tb_axi_bram_ctrl_Instr_bram_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source microcontroler_tb_axi_bram_ctrl_Instr_bram_1.tcl
