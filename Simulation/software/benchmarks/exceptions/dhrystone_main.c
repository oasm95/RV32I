...
extern void interruptCPU();
extern void _disableintr();
extern void _enableintr(int);
extern void _setvectored();
  ...
  /* Main and Proc_0 in the Ada version             */
{
  ...
  while (!Done) {
    ...
    {
      if (Run_Index == 50) misalignedLoadHW();
      Proc_5();
      Proc_4();
      if (Run_Index == 100) misalignedLoadW();      
	/* Ch_1_Glob == 'A', Ch_2_Glob == 'B', Bool_Glob == true */
      Int_1_Loc = 2;
      Int_2_Loc = 3;
      if (Run_Index == 150) misalignedStoreHW();
      strcpy (Str_2_Loc, "DHRYSTONE PROGRAM, 2'ND STRING");
      if (Run_Index == 200) misalignedStoreW();
      Enum_Loc = Ident_2;
      
      Bool_Glob = ! Func_2 (Str_1_Loc, Str_2_Loc);
	/* Bool_Glob == 1 */
      if (Run_Index == 250) ebreak();
	...
	Int_1_Loc += 1;
      ...
      if (Run_Index == 300) illop();
	/* Int_1_Loc == 3, Int_2_Loc == 3, Int_3_Loc == 7 */
      Proc_8 (Arr_1_Glob, Arr_2_Glob, Int_1_Loc, Int_3_Loc);
      if (Run_Index == 350) misalignedJAL();
	/* Int_Glob == 5 */
      Proc_1 (Ptr_Glob);
      if (Run_Index == 400) misalignedJALR();
	...
	if (Enum_Loc == Func_1 (Ch_Index, 'C'))
      ...
      if (Run_Index == 450) misalignedCondJMPTrue();
	/* Int_1_Loc == 3, Int_2_Loc == 3, Int_3_Loc == 7 */
      Int_2_Loc = Int_2_Loc * Int_1_Loc;
      Int_1_Loc = Int_2_Loc / Int_3_Loc;
      Int_2_Loc = 7 * (Int_2_Loc - Int_3_Loc) - Int_1_Loc;
	/* Int_1_Loc == 1, Int_2_Loc == 13, Int_3_Loc == 7 */
      if (Run_Index == 498) misalignedCondJMPFalse();
      Proc_2 (&Int_1_Loc);
	/* Int_1_Loc == 5 */
