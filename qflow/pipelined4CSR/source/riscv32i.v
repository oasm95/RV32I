...
module alu_32(a, b, funsel, c, z, condtrue);
  ...
  assign _31_ = \1265 (32'hxxxxxxxx, { a, b, _27_, _24_, _22_, _20_, _18_, _16_, 31'h00000000, _12_, 31'h00000000, _07_, _04_, _02_, _00_ }, { _30_, _29_, _28_, _25_, _23_, _21_, _19_, _17_, _15_, _10_, _05_, _03_, _01_ });
...
module csrfile_32(clk, extern_irq, csr_mepc, csr_wdata, csr_mcause, csr_raddr, csr_waddr, csr_wen, csr_wen_traps, csr_ret, csr_irq, csr_pcaddr, csr_data);
  ...
  assign \trap_addr.mvect_out  = \1052 (\trap_addr.mvect_out , { _03_, mvect[31:2], 2'h0 }, { _04_, _02_ });
  ...
  assign \trap_addr.pcaddr  = \1060 (\trap_addr.pcaddr , { \trap_addr.mvect_out , mepc, 2'h0 }, { _06_, _05_ });
  ...
  assign _45_ = \1194 (32'd0, { 20'h00000, mip, 31'h00000000, mie, 11'h000, mepc, 34'h040000100, mvect, 24'h000018, mstatus[1], 3'h0, mstatus[0], 3'h0, mcause }, { _44_, _43_, _42_, _41_, _40_, _39_, _38_ });
  assign csr_irq = irq;
...
module datapath_32_39d7544d97a008fb17fbddd8b87380f3cfa24caa(clk, stall, extern_irq, imem_instruction, dmem_dataload, pc_sel, a_sel, b_sel, wb_sel, imm_sel, alu_sel, regfile_wen, csrfile_wen, csrfile_trap_wen, mret, ecall, ebreak, ill_op, imem_addr, dmem_addr, dmem_datastore, trap, wbtrap, id_opcode, id_funct3, id_funct7, alu_opcode, alu_funct3, alu_funct7, mem_opcode, mem_funct3, mem_funct7, wb_opcode, wb_funct3);
  ...
  assign _12_ = meminstr[6:0] == 7'h63;
  assign isbranch = _12_ ? 1'h1 : 1'h0;
  assign _13_ = { meminstr[14], meminstr[12] } == 2'h0;
  assign _14_ = ~ regz;
  assign _15_ = { meminstr[14], meminstr[12] } == 2'h1;
  assign _16_ = { meminstr[14], meminstr[12] } == 2'h2;
  assign _17_ = ~ regcondt;
  assign _18_ = { meminstr[14], meminstr[12] } == 2'h3;
  function [0:0] \578 ;
    input [0:0] a;
    input [3:0] b;
    input [3:0] s;
  ...
  assign tkbranch = \578 (tkbranch, { _17_, regcondt, _14_, regz }, { _18_, _16_, _15_, _13_ });
  always @(posedge clk)
    mempc <= alupc;
  always @(posedge clk)
    mempc_4 <= alupc_4;
  ...
  assign rd = \679 (rd, { regcsrwb, wbpc_4, regloadwb, regcwb }, { _30_, _29_, _28_, _27_ });
  assign _31_ = regpcsel[0] | trap_wrap;
  assign _32_ = isbranch & tkbranch;
  assign _33_ = _31_ | _32_;
  assign _34_ = _33_ | regmret;
  assign _35_ = regpcsel[1] | trap_wrap;
...
module immdecoder_32(instruction, imm_sel, immediate);
  ...
  assign _11_ = \1014 (11'hxxx, { 11'h000, instruction[24], instruction[24], instruction[24], instruction[24], instruction[24], instruction[24], instruction[24], instruction[24], instruction[24], instruction[24], instruction[24:13], instruction[24], instruction[24], instruction[24], instruction[24], instruction[24], instruction[24], instruction[24], instruction[24], instruction[24], instruction[24], instruction[24], instruction[24], instruction[24], instruction[24], instruction[24], instruction[24], instruction[24], instruction[24], instruction[24], instruction[24], instruction[24], instruction[24], instruction[24], instruction[24], instruction[24], instruction[24], instruction[24], instruction[24], instruction[24], instruction[24], instruction[24], instruction[24], instruction[24] }, { _05_, _04_, _03_, _02_, _01_, _00_ });
  function [0:0] \1021 ;
    input [0:0] a;
    input [5:0] b;
    input [5:0] s;
  ...
  assign _12_ = \1021 (1'hx, { 1'h0, instruction[24], instruction[24], instruction[24], instruction[24], instruction[24] }, { _05_, _04_, _03_, _02_, _01_, _00_ });
  ...
  assign _06_ = \980 (1'hx, { instruction[8], 3'h0, instruction[0], instruction[13] }, { _05_, _04_, _03_, _02_, _01_, _00_ });
  function [3:0] \987 ;
    input [3:0] a;
    input [23:0] b;
    input [5:0] s;
  ...
  assign _07_ = \987 (4'hx, { instruction[12:9], instruction[17:14], 4'h0, instruction[4:1], instruction[4:1], instruction[17:14] }, { _05_, _04_, _03_, _02_, _01_, _00_ });
  function [5:0] \993 ;
    input [5:0] a;
    input [35:0] b;
    input [5:0] s;
  ...
  assign _08_ = \993 (6'hxx, { 6'h00, instruction[23:18], 6'h00, instruction[23:18], instruction[23:18], instruction[23:18] }, { _05_, _04_, _03_, _02_, _01_, _00_ });
  function [0:0] \999 ;
    input [0:0] a;
    input [5:0] b;
    input [5:0] s;
  ...
  assign _09_ = \999 (1'hx, { 1'h0, instruction[13], 1'h0, instruction[0], instruction[24], instruction[24] }, { _05_, _04_, _03_, _02_, _01_, _00_ });
...
module meminterface_32(extern_data_load, data_store, mem_addr, mem_size, extern_data_store, extern_mem_addr, data_load);
  ...
  assign \byte_size_load.byteval  = \1295 (\byte_size_load.byteval , extern_data_load, { _03_, _02_, _01_, _00_ });
  ...
  assign \byte_size_load.extension  = \1336 (\byte_size_load.extension , { 24'h000000, \byte_size_load.byteval [7], \byte_size_load.byteval [7], \byte_size_load.byteval [7], \byte_size_load.byteval [7], \byte_size_load.byteval [7], \byte_size_load.byteval [7], \byte_size_load.byteval [7], \byte_size_load.byteval [7], \byte_size_load.byteval [7], \byte_size_load.byteval [7], \byte_size_load.byteval [7], \byte_size_load.byteval [7], \byte_size_load.byteval [7], \byte_size_load.byteval [7], \byte_size_load.byteval [7], \byte_size_load.byteval [7], \byte_size_load.byteval [7], \byte_size_load.byteval [7], \byte_size_load.byteval [7], \byte_size_load.byteval [7], \byte_size_load.byteval [7], \byte_size_load.byteval [7], \byte_size_load.byteval [7], \byte_size_load.byteval [7] }, { _05_, _04_ });
  ...
  assign \halfword_size_load.halfwordval  = \1350 (\halfword_size_load.halfwordval , extern_data_load, { _07_, _06_ });
  ...
  assign \halfword_size_load.extension  = \1379 (\halfword_size_load.extension , { 16'h0000, \halfword_size_load.halfwordval [15], \halfword_size_load.halfwordval [15], \halfword_size_load.halfwordval [15], \halfword_size_load.halfwordval [15], \halfword_size_load.halfwordval [15], \halfword_size_load.halfwordval [15], \halfword_size_load.halfwordval [15], \halfword_size_load.halfwordval [15], \halfword_size_load.halfwordval [15], \halfword_size_load.halfwordval [15], \halfword_size_load.halfwordval [15], \halfword_size_load.halfwordval [15], \halfword_size_load.halfwordval [15], \halfword_size_load.halfwordval [15], \halfword_size_load.halfwordval [15], \halfword_size_load.halfwordval [15] }, { _09_, _08_ });
  ...
  assign _13_ = \1392 (32'hxxxxxxxx, { extern_data_load, \halfword_size_load.extension , \halfword_size_load.halfwordval , \byte_size_load.extension , \byte_size_load.byteval  }, { _12_, _11_, _10_ });
  ...
  assign \byte_size_store.storebyte  = \1422 (\byte_size_store.storebyte , { data_store[7:0], extern_data_load[23:0], extern_data_load[31:24], data_store[7:0], extern_data_load[15:0], extern_data_load[31:16], data_store[7:0], extern_data_load[7:0], extern_data_load[31:8], data_store[7:0] }, { _17_, _16_, _15_, _14_ });
  ...
  assign \halfword_size_store.storehalfw  = \1438 (\halfword_size_store.storehalfw , { extern_data_load[31:16], data_store[15:0], data_store[15:0], extern_data_load[15:0] }, { _19_, _18_ });
  ...
  assign _23_ = \1450 (32'hxxxxxxxx, { data_store, \halfword_size_store.storehalfw , \byte_size_store.storebyte  }, { _22_, _21_, _20_ });
...
module programcounter_32_39d7544d97a008fb17fbddd8b87380f3cfa24caa(clk, jumps, except_addr, jalr, pc_sel, stall, current_addr, next_addr);
  ...
  assign pc_mux = \793 (pc_mux, { jalr, next_instruction, except_addr, jumps }, { _5_, _4_, _3_, _2_ });
...
module registerfile_32(clk, rega_addr, regb_addr, w_data, w_addr, w_en, rega_data, regb_data);
  ...
  always @(posedge clk) begin
    if (_1_) \838 [w_addr] <= w_data;
  end
  assign _7_ = \838 [regb_addr];
  assign _9_ = \838 [rega_addr];
